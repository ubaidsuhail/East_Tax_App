...
class HomeThreeOptionContainer extends StatefulWidget {
  String identity;
  ...
  HomeThreeOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData});
  @override
  _HomeThreeOptionContainerState createState() => _HomeThreeOptionContainerState();
}

class _HomeThreeOptionContainerState extends State<HomeThreeOptionContainer> {
  bool open = false;
  bool v3 = false;
