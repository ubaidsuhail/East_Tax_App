...
class HomeMultipleOptionsContainerNo extends StatefulWidget {
  String identity;
  ...
  HomeMultipleOptionsContainerNo({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.answerImages,this.containerSize,this.additionalData,this.multipleData});
  @override
  _HomeMultipleOptionsContainerNoState createState() => _HomeMultipleOptionsContainerNoState();
}

class _HomeMultipleOptionsContainerNoState extends State<HomeMultipleOptionsContainerNo> {
  bool open = false;
  bool v3 = false;
  String noOption = "";
...
//                                          SizedBox(width: 20.0,),
//                                          AutoSizeText(widget.answerOption[index],style: TextStyle(color: Color.fromARGB(0XFF, 0X38, 0Xb6, 0XFF)),
//                                            minFontSize: 14,
//                                            maxLines: 1,
