...
class FourOptionContainer extends StatefulWidget {
  ...
  FourOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize});
                        ...
                        itemBuilder: (BuildContext ctxt, int index) {
                          return GestureDetector(
                              onTap: (){
                                ...
                                Questions.residence = widget.answerOption[index];
