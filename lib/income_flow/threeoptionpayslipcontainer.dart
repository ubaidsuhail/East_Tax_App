...
class ThreeOptionPaySlipContainer extends StatefulWidget {
  ...
  ThreeOptionPaySlipContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.PaySlipNo});
                          ...
                          return GestureDetector(
                              ...
                              child: Column(
                                  children: <Widget>[
                                    ...
                                    ListTile(
                                      title:Text(widget.answerOption[index],style:TextStyle(color: Colors.lightBlue,fontWeight: FontWeight.bold),textAlign: TextAlign.center, ),
                                    ),
