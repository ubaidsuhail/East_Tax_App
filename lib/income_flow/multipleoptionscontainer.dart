...
class MultiOptionsContainer extends StatefulWidget {
  String identity;
  ...
  MultiOptionsContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.answerImages,this.containerSize});
  @override
  _HomeScreenState createState() => _HomeScreenState();
}

class _HomeScreenState extends State<MultiOptionsContainer> {
  bool open = false;
  bool v3 = false;
