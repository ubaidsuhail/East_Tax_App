...
class HealthDateContainer extends StatefulWidget {
  String identity;
  ...
  HealthDateContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _HealthDateContainerState createState() => _HealthDateContainerState();
}

class _HealthDateContainerState extends State<HealthDateContainer> {
...
//                    color: Colors.wh,
  ...
  void AddData()
  {
    ...
    qu.HealthAddAnswer(widget.identity,widget.bigQuestion,widget.completeQuestion, widget.questionOption, [dates.text.toString()], 55.0);
