...
class HealthFullAddress extends StatefulWidget {
  String identity;
  ...
  HealthFullAddress({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.containerSize});
  @override
  _HealthFullAddressState createState() => _HealthFullAddressState();
}

class _HealthFullAddressState extends State<HealthFullAddress> {
  ...
  void AddData()
  {
    qu.HealthAddAnswer(widget.identity,widget.bigQuestion,widget.completeQuestion, widget.questionOption, [_city.text+" , "+ _country.text], 55.0);
