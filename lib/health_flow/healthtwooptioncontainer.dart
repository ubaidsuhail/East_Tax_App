...
class HealthTwoOptionContainer extends StatefulWidget {
  ...
  HealthTwoOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _HealthTwoOptionContainerState createState() => _HealthTwoOptionContainerState();
}
                              ...
                              onTap: (){
                                ...
                                if(widget.answerOption[index] == "Abroad")
                                {
                                  ...
                                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                                    return HealthAbroad(identity: widget.identity,bigQuestion:widget.bigQuestion,completeQuestion: widget.completeQuestion,questionOption: widget.questionOption,containerSize: widget.containerSize);
                                  }));
//                                Navigator.push(context, MaterialPageRoute(builder: (context) {
...
//                                }));
                                ...
                                {
                                  qu.HealthAddAnswer(widget.identity,widget.bigQuestion,widget.completeQuestion,widget.questionOption, [widget.answerOption[index]], 55.0);

                                  Navigator.of(context).pop();
                                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                                    return HealthMainQuestions(CheckCompleteQuestion : widget.completeQuestion,CheckQuestion : widget.questionOption,CheckAnswer : [widget.answerOption[index]]);
                                  }));
