...
class HealthMultiTwoContainer extends StatefulWidget {
  String identity;
  ...
  HealthMultiTwoContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.answerImages,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _HealthMultiTwoContainerState createState() => _HealthMultiTwoContainerState();
}

class _HealthMultiTwoContainerState extends State<HealthMultiTwoContainer> {
  bool open = false;
  bool v3 = false;
