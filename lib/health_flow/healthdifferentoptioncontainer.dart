...
class HealthDifferentOptionContainer extends StatefulWidget {
  String identity;
  ...
  HealthDifferentOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _HealthDifferentOptionContainerState createState() => _HealthDifferentOptionContainerState();
}

class _HealthDifferentOptionContainerState extends State<HealthDifferentOptionContainer> {
  bool open = false;
  bool v3 = false;
