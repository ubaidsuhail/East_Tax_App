...
class HealthMultiThreeContainer extends StatefulWidget {
  String identity;
  ...
  HealthMultiThreeContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.answerImages,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _HealthMultiThreeContainerState createState() => _HealthMultiThreeContainerState();
}

class _HealthMultiThreeContainerState extends State<HealthMultiThreeContainer> {
  bool open = false;
  bool v3 = false;
