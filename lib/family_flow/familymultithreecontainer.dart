...
class FamilyMultiThreeContainer extends StatefulWidget {
  String identity;
  ...
  FamilyMultiThreeContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.answerImages,this.containerSize,this.additionalData,this.multipleData});
  @override
  _FamilyMultiThreeContainerState createState() => _FamilyMultiThreeContainerState();
}

class _FamilyMultiThreeContainerState extends State<FamilyMultiThreeContainer> {
  bool open = false;
  bool v3 = false;
