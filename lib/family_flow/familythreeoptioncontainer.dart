...
class FamilyThreeOptionContainer extends StatefulWidget {
  ...
  FamilyThreeOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData});
  @override
  _FamilyThreeOptionContainerState createState() => _FamilyThreeOptionContainerState();
}

class _FamilyThreeOptionContainerState extends State<FamilyThreeOptionContainer> {
  bool open = false;
  bool v3 = false;
