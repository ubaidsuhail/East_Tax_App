...
import 'package:easy_taxx/family_flow/familyfulladdress.dart';

class FamilyAddressContainer extends StatefulWidget {
  String identity;
  ...
  FamilyAddressContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.containerSize,this.additionalData,this.multipleData});
  @override
  _FamilyAddressContainerState createState() => _FamilyAddressContainerState();
}

class _FamilyAddressContainerState extends State<FamilyAddressContainer> {
...
//    }));
    ...
    Navigator.of(context).pop();
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return FamilyFullAddress(identity: widget.identity,bigQuestion:widget.bigQuestion,completeQuestion: widget.completeQuestion,questionOption: widget.questionOption,containerSize: widget.containerSize);
    }));
