...
class EducationMultiTwoContainer extends StatefulWidget {
  String identity;
  ...
  EducationMultiTwoContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.answerImages,this.containerSize,this.additionalData,this.multipleData});
  @override
  _EducationMultiTwoContainerState createState() => _EducationMultiTwoContainerState();
}

class _EducationMultiTwoContainerState extends State<EducationMultiTwoContainer> {
  bool open = false;
  bool v3 = false;
