              ...
              child: Padding(
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    children: <Widget>[
                      ...
                      Text(Questions.educationAnswerShow[i]['question'],style: TextStyle(fontWeight: FontWeight.bold),),
                      Row(children: <Widget>[
                        //Text(Questions.answerShow[i]['answer'],style: TextStyle(color: Colors.lightBlue)),
                        Text(Questions.educationAnswerShow[i]['answer'][0]),
                        SizedBox(width: 10.0,),
                        ...
                        children: <Widget>[
                          ...
                          Row(children: <Widget>[
                            ...
                            Container(
                              width: 140.0,
                           // color:Colors.blue,
                            child:AutoSizeText(Questions.educationAnswerShow[j]['answer'][0],textAlign: TextAlign.end,minFontSize: 14.0,maxLines: 1,overflow: TextOverflow.ellipsis,),),
                            SizedBox(width: 5.0,),
                            Icon(Icons.arrow_forward_ios, size: 12.0,
                              color: Colors.lightBlue,)
                          ],)
...
//    Yaha multiple hoga dobara
  ...
  {
    Questions.educationAnimatedContainer = animatedcontainer;
    return EducationDifferentOptionContainer(identity:Identity,bigQuestion:BigQuestion,completeQuestion:CompleteQuestion,questionOption:QuestionOption,answerOption:AnswerOption,containerSize:420.0,additionalData:AdditionalData,multipleData:MultipleData);
  }
