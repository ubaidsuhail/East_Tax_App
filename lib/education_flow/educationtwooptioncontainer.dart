...
import 'package:easy_taxx/education_flow/educationabroad.dart';




class EducationTwoOptionContainer extends StatefulWidget {
  String identity;
  ...
  EducationTwoOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData});
  @override
  _EducationTwoOptionContainerState createState() => _EducationTwoOptionContainerState();
}

class _EducationTwoOptionContainerState extends State<EducationTwoOptionContainer> {
  bool open = false;
  bool v3 = false;
                          ...
                          return GestureDetector(
                              onTap: (){
                                ...
                                Navigator.push(context, MaterialPageRoute(builder: (context) {
                                  return EducationAbroad(identity: widget.identity,bigQuestion:widget.bigQuestion,completeQuestion: widget.completeQuestion,questionOption: widget.questionOption,containerSize: widget.containerSize);
                                }));
//                                Navigator.push(context, MaterialPageRoute(builder: (context) {
