...
class EducationDifferentOptionContainer extends StatefulWidget {
  String identity;
  ...
  EducationDifferentOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData});
  @override
  _EducationDifferentOptionContainerState createState() => _EducationDifferentOptionContainerState();
}

class _EducationDifferentOptionContainerState extends State<EducationDifferentOptionContainer> {
  bool open = false;
  bool v3 = false;
