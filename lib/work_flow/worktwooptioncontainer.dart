...
import 'package:easy_taxx/work_flow/workabroad.dart';
import 'package:easy_taxx/datamodels/designfile.dart';



class WorkTwoOptionContainer extends StatefulWidget {
  String identity;
  ...
  WorkTwoOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _WorkTwoOptionContainerState createState() => _WorkTwoOptionContainerState();
}

class _WorkTwoOptionContainerState extends State<WorkTwoOptionContainer> {
  bool open = false;
  bool v3 = false;
                              ...
                              onTap: (){
                                ...
                                if(widget.answerOption[index] == "Abroad")
                                {
                                  ...
                                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                                    return WorkAbroad(identity: widget.identity,bigQuestion:widget.bigQuestion,completeQuestion: widget.completeQuestion,questionOption: widget.questionOption,containerSize: widget.containerSize);
                                  }));
//                                Navigator.push(context, MaterialPageRoute(builder: (context) {
