...
class WorkDifferentOptionContainer extends StatefulWidget {
  ...
  WorkDifferentOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _WorkDifferentOptionContainerState createState() => _WorkDifferentOptionContainerState();
}

class _WorkDifferentOptionContainerState extends State<WorkDifferentOptionContainer> {
  bool open = false;
  bool v3 = false;
