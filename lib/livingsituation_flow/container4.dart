...
class Container4 extends StatefulWidget {
  ...
  Container4({this.Identity,this.BigQuestion,this.Question,this.QuestionOption,this.AnswerOption,this.AnswerImages,this.Containersize});
  @override
  _HomeScreenState createState() => _HomeScreenState();
}

class _HomeScreenState extends State<Container4> {
  bool open = false;
  bool v3 = false;
