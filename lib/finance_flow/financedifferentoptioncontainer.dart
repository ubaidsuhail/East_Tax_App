...
class FinanceDifferentOptionContainer extends StatefulWidget {
  ...
  FinanceDifferentOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _FinanceDifferentOptionContainerState createState() => _FinanceDifferentOptionContainerState();
}

class _FinanceDifferentOptionContainerState extends State<FinanceDifferentOptionContainer> {
  bool open = false;
  bool v3 = false;
