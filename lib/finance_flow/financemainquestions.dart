              ...
              child: Padding(
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    children: <Widget>[
                      ...
                      Text(Questions.financeAnswerShow[i]['question'],
                        style: TextStyle(fontWeight: FontWeight.bold),),
                      Row(children: <Widget>[
                        //Text(Questions.answerShow[i]['answer'],style: TextStyle(color: Colors.lightBlue)),
                        Text(Questions.financeAnswerShow[i]['answer'][0]),
                        SizedBox(width: 10.0,),
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                              ...
                              //color: Colors.purple,
                              child: AutoSizeText(
                                Questions.financeAnswerShow[j]['question'],
                          ...
                          Row(children: <Widget>[
                            ...
                            Container(
                              ...
                              // color:Colors.blue,
                              child: AutoSizeText(
                                Questions.financeAnswerShow[j]['answer'][0],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'Finances', style: TextStyle(color: Colors.black, fontSize: 14.0),),
          centerTitle: true,
        ),
