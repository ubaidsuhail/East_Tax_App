...
class FinanceMultiTwoContainer extends StatefulWidget {
  ...
  FinanceMultiTwoContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.answerImages,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _FinanceMultiTwoContainerState createState() => _FinanceMultiTwoContainerState();
}
