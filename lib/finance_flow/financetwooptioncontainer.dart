...
class FinanceTwoOptionContainer extends StatefulWidget {
  String identity;
  ...
  FinanceTwoOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _FinanceTwoOptionContainerState createState() => _FinanceTwoOptionContainerState();
}

class _FinanceTwoOptionContainerState extends State<FinanceTwoOptionContainer> {
  bool open = false;
  bool v3 = false;
