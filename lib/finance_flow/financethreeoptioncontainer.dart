...
class FinanceThreeOptionContainer extends StatefulWidget {
  String identity;
  ...
  FinanceThreeOptionContainer({this.identity,this.bigQuestion,this.completeQuestion,this.questionOption,this.answerOption,this.containerSize,this.additionalData,this.multipleData,this.suggestion});
  @override
  _FinanceThreeOptionContainerState createState() => _FinanceThreeOptionContainerState();
}

class _FinanceThreeOptionContainerState extends State<FinanceThreeOptionContainer> {
  bool open = false;
  bool v3 = false;
                      ...
                      (
                        ...
                        itemBuilder: (BuildContext ctxt, int index) {
                          return GestureDetector(
                              onTap: (){
                                qu.FinanceAddAnswer(widget.identity,widget.bigQuestion,widget.completeQuestion,widget.questionOption, [widget.answerOption[index]], 55.0);

                                Navigator.of(context).pop();
                                Navigator.push(context, MaterialPageRoute(builder: (context) {
                                  return FinanceMainQuestions(CheckCompleteQuestion : widget.completeQuestion,CheckQuestion : widget.questionOption,CheckAnswer : [widget.answerOption[index]]);
                                }));
